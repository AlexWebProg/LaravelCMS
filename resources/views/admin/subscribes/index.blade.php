...
@section('content')
    ...
    <div class="content-wrapper">
                    ...
                    <div class="card-body pl-0 pr-0">
                        <div id="group_action_buttons">
                            <div id="group_action_buttons_content">
                                ...
                                <button id="showAssemblyFormBtn" class="btn btn-info group_action_button" disabled="disabled"><i class="fa fa-archive mr-2 d-none d-sm-inline" aria-hidden="true"></i>Сборка</button>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="assemblyFormModal">
            <form id="assemblyForm" action="{{ route('admin.subscribes.assemblyMany') }}" method="post">
                @csrf
                @method('patch')
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Сборка выбранных подписок</h4>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="assembly_month">Месяц, за который выполняется сборка</label>
                                <input type="text" class="form-control datetimepicker-input" id="assembly_month" data-toggle="datetimepicker" data-target="#assembly_month" name="assembly_month" value="{{ $arPlannedDataLine[0]['str'] }}" placeholder="Месяц, за который выполняется сборка ..." required="required"/>
                            </div>
                        </div>
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="submit" class="btn btn-success"><i class="fa fa-check mr-2 d-none d-sm-inline" aria-hidden="true"></i>Собрать</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
